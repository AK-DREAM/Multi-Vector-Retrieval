...
text_retrieval_datasets = ["trec-covid", "nq", "climate-fever", "hotpotqa", "msmarco", "webis-touche2020", "scifact", "fiqa", "strategyqa", "squad"]
...
def parse_args():
    ...
    args = parser.parse_args(args=['--dataset_name', 'squad',
                                   '--data_path', 'data/',
...
if args.dataset_name == "squad":
    ...
    with open("/home/icml01/datasets/squad/corpus.pkl", "rb") as file:  
