...
def decompose_queries_vllm(queries, sub_queries_ls, query_key_ls=None):
    ...
    for qid in tqdm(query_key_ls):
        query = queries[qid]
        sub_queries[rid_to_idx[qid]] = sub_queries_ls[cnt]
        cnt += 1
