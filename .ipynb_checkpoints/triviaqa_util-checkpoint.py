...
text_retrieval_datasets = ["trec-covid", "nq", "climate-fever", "hotpotqa", "msmarco", "webis-touche2020", "scifact", "fiqa", "strategyqa", "squad", 'triviaqa']
...
def parse_args():
    ...
    args = parser.parse_args(args=['--dataset_name', 'triviaqa',
                                   '--data_path', 'data/',
...
if args.dataset_name == "triviaqa":
    ...
    with open("/home/icml01/datasets/triviaqa/corpus.pkl", "rb") as file:  
...
questions = ['Who was the man behind The Chipmunks?']

sub_query_str_l = [
    [['man behind' , 'Chipmunks']]
]
