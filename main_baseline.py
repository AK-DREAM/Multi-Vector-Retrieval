...
def calc_sim_score(args, query_emb, subquery_embs, doc_embs, subdoc_embs, subdoc_cnt):
    ...
    score = score1/torch.sum(score1, dim=-1, keepdim=True)
...
def search_and_load_data(
    ...
    return sample_ids_gpu, sample_doc_embs, None, None
...
if __name__ == "__main__":       
    ...
    for idx in tqdm(range(query_count), desc="processing queries"):
        ...
        sim_score = calc_sim_score(args, fullquery_emb, None, sample_doc_embs, sample_subdoc_embs, sample_subdoc_cnt)
